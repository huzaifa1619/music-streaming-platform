...
public class SignupUI extends JFrame {
    ...
    public SignupUI() {
        ...
        n.setForeground(SUBTEXT);
        n.setBounds(24, 80, 100, 20);
        add(n);

        JTextField fullname = new JTextField();
        fullname.setBounds(24, 100, 420, 36);
        fullname.setBackground(SURFACE);
        fullname.setForeground(TEXT);
        fullname.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
        add(fullname);

        JLabel u = new JLabel("Username");
        u.setForeground(SUBTEXT);
        u.setBounds(24, 150, 100, 20);
        add(u);

        JTextField username = new JTextField();
        username.setBounds(24, 170, 420, 36);
        username.setBackground(SURFACE);
        username.setForeground(TEXT);
        username.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
        add(username);

        JLabel p = new JLabel("Password");
        p.setForeground(SUBTEXT);
        p.setBounds(24, 220, 100, 20);
        add(p);

        JPasswordField password = new JPasswordField();
        password.setBounds(24, 240, 420, 36);
        password.setBackground(SURFACE);
